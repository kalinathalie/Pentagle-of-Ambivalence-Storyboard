...
namespace StorybrewScripts{
    public class LyricsCalmPart : StoryboardObjectGenerator{
        ...
        public void generatePerCharacter(FontGenerator font, SubtitleSet subtitles, StoryboardLayer layer, string TimestampSplit){
            ...
            var trace = layer.CreateSprite(TracePath, OsbOrigin.TopLeft, new Vector2(-20, 13));

            trace.ScaleVec(StartTrace-tick(0,(double)1/(double)2), EndTrace, 200, 14, 200, 14);
            trace.Fade(StartTrace-tick(0,(double)1/(double)3),0.6);
            trace.ScaleVec((OsbEasing) 7, EndTrace, EndTrace+tick(0,1), 200, 14, 200, 0);
                ...
                foreach (var line in subtitleLine.Text.Split('\0')){
                    ...
                    foreach (var letter in line){
                        ...
                        if (!texture.IsEmpty){
                            ...
                            //begin
                            sprite.Scale(LineStart+aniLyrics-tick(0,0.5)+tick(0,2), FontScale-0.1f);
                            ...
                            //pulse
                            sprite.Scale(subtitleLine.StartTime - 50, subtitleLine.StartTime + 50, FontScale-0.1f, FontScale);
